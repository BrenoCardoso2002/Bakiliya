...
class Add_Cliente_Empresa : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_add_cliente_empresa)
        if(!verificaInternet()){
            alertaSemConexao()
        }
        ...
        inputNome = findViewById(R.id.Input_NomeFantasia_AddEmpresa)
        inputCnpj = findViewById(R.id.Input_CNPJ_AddEmpresa)
        inputEmail = findViewById(R.id.Input_Email_AddEmpresa)
        inputContato = findViewById(R.id.Input_Contato_AddEmpresa)
        inputCep = findViewById(R.id.Input_CEP_AddEmpresa)
        inputNrua = findViewById(R.id.Input_Numero_AddEmpresa)
        txtIcep = findViewById(R.id.TextView_DadosCEP_AddEmpresa)
        bVerMais = findViewById(R.id.Button_VerMais_AddEmpresa)
        bAdicionar = findViewById(R.id.Button_Adicionar_AddEmpresa)
        ...
        bAdicionar.setOnClickListener{
            ...
            if (nomeS.isEmpty() || cnpjS.isEmpty() || emailS.isEmpty() || contatoS.isEmpty() || cepS.isEmpty() || ruaS.isEmpty()){
    ...
    private fun alertError(descripton: String) {
        ...
        val dialogBinding = layoutInflater.inflate(R.layout.error_in_add_empresa, null)
        val myDialog = Dialog(this)
        myDialog.setContentView(dialogBinding)
        myDialog.setCancelable(true)
        myDialog.window?.setBackgroundDrawable(ColorDrawable(Color.TRANSPARENT))
        myDialog.show()
        myDialog.findViewById<TextView>(R.id.TextView_DescriptionError_AddEmpresa).text = descripton
        myDialog.findViewById<Button>(R.id.Button_OK_erroAddEmpresa).setOnClickListener {
            myDialog.dismiss()
        }
    }

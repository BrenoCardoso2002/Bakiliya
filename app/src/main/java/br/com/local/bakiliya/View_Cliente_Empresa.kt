...
class View_Cliente_Empresa : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_view_cliente_empresa)
        if(!verificaInternet()){
            alertaSemConexao()
        }

        txtNome = findViewById<TextView>(R.id.TextView_Nome_ViewClienteEmpresa)
        txtCodigo = findViewById<TextView>(R.id.TextView_CNPJ_ViewClienteEmpresa)
        txtEmail = findViewById<TextView>(R.id.TextView_Email_ViewClienteEmpresa)
        txtContato = findViewById<TextView>(R.id.TextView_Contato_ViewClienteEmpresa)
        txtCep = findViewById<TextView>(R.id.TextView_CEP_ViewClienteEmpresa)
        txtNrua = findViewById<TextView>(R.id.TextView_NRUA_ViewClienteEmpresa)
        txtIcep = findViewById(R.id.TextView_DadosCEP_ViewClienteEmpresa)
        bVerMais = findViewById(R.id.Button_VerMais_ViewClienteEmpresa)
        bLigacao = findViewById(R.id.efetuarLigacao_ClienteEmpresa)
